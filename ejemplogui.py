...
entry = ttk.Entry(root, justify=tk.RIGHT,show='*', width=10)
entry.config(state=tk.NORMAL)

#texto inicial en la casilla
entry.insert(0,"Hola Mundo!")
entry.place(x=50, y=50)

button = ttk.Button(root, text='obtener texto', command=lambda:print(entry.get()))
...
#para imprimir?     entry = ttk.Entry(root, state="readonly")
